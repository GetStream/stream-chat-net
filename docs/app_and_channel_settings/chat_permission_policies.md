...
- **Application Permissions** : You can grant these using the .app scope. These permissions apply to operations that occur outside of channel-types including accessing and [modifying other users](/chat/docs/dotnet-csharp/update_users/), or [using moderation features](/chat/docs/dotnet-csharp/moderation/).
...
> [!NOTE]
> You can also find all available permissions on [Permissions Reference](/chat/docs/dotnet-csharp/permissions_reference/) page
...
For grouping users into teams (or tenants) to keep their data strictly segregated, see [Multi-Tenancy](/chat/docs/dotnet-csharp/multi_tenant_chat/).
