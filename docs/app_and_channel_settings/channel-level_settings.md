In most cases, you define your channel settings and features at the [Channel Type](/chat/docs/dotnet-csharp/channel_features/) level and then have these inherited by all the channels of the same type. For instance you can configure [Livestream](/chat/docs/dotnet-csharp/channel_features/) channels without typing events and enable reactions and replies for all [Messaging](/chat/docs/dotnet-csharp/channel_features/) type channels.
...
- **grants** : Allows to modify channel-type permission grants for particular channel. More information can be found [here](/chat/docs/dotnet-csharp/chat_permission_policies/)

- **user_message_reminders** : Allow users to set reminders for messages. More information can be found [here](/chat/docs/dotnet-csharp/message_reminders/)

- **shared_locations** : Allow users to share their current location. More information can be found [here](/chat/docs/dotnet-csharp/location_sharing/)
