...
The five default channel types come with good default permission policies. You can find more information on how to manage permissions in the [Channel Types section](/chat/docs/dotnet-csharp/chat_permission_policies/).
...
Please note that applications have a hard limit of 50 channel types. If you need more than this please have a look at the [Multi-tenant & Teams](/chat/docs/dotnet-csharp/multi_tenant_chat/) section.
