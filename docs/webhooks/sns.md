...
The complete list of supported events is identical to those sent through webhooks and can be found on the [Events](/chat/docs/dotnet-csharp/webhook_events/) page.
...
var newSNSHook = new EventHook
{
    ...
    SnsRegion = "us-east-1",
    SnsAuthType = AuthType.Keys, // or Resource for role-based auth
    SnsKey = "yourkey",
