...
| ------------------------------------------------------- | ---------------------------------------------------- | ------------------ | ---------------------- |
| [Archiving](/chat/docs/dotnet-csharp/archiving_channels/) | Mark a channel as archived for a specific user       | Per-user state     | No data loss           |
| [Pinning](/chat/docs/dotnet-csharp/pinning_channels/)     | Mark a channel as pinned for a specific user         | Per-user state     | No data loss           |
| [Muting](/chat/docs/dotnet-csharp/muting_channels/)       | Suppress notifications for a channel                 | Per-user state     | No data loss           |
| [Hiding](/chat/docs/dotnet-csharp/hiding_channels/)       | Hide a channel from query results until new messages | Per-user state     | Optional history clear |
| [Disabling](/chat/docs/dotnet-csharp/disabling_channels/) | Prevent all client-side access to a channel          | All users affected | No data loss           |
| [Freezing](/chat/docs/dotnet-csharp/freezing_channels/)   | Prevent new messages and reactions                   | All users affected | No data loss           |
| [Truncating](/chat/docs/dotnet-csharp/truncate_channel/)  | Remove messages from a channel                       | All users affected | Message data deleted   |
| [Deleting](/chat/docs/dotnet-csharp/channel_delete/)      | Permanently remove a channel                         | All users affected | All data deleted       |
