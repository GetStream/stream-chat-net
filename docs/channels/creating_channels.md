...
For loading many channels at once, use [client.queryChannels()](/chat/docs/dotnet-csharp/query_channels/)—this fetches and watches multiple channels in a single call, reducing API traffic.
