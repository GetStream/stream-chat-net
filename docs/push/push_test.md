...
- Your app has push notifications configured for at least one provider [in your app settings](/chat/docs/dotnet-csharp/app_setting_overview/)

- You have a user that has at least one [device](/chat/docs/dotnet-csharp/#push_devices/) associated
