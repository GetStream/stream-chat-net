...
For more details on permissions, see [User Permissions](/chat/docs/dotnet-csharp/chat_permission_policies/).
...
For more details, see [App Settings](/chat/docs/dotnet-csharp/app_setting_overview/).
...
For more details, see [Slow Mode & Throttling](/chat/docs/dotnet-csharp/slow_mode/).
