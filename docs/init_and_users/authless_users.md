...
Guest users have a limited set of permissions. You can read more about how to configure permissions [here](/chat/docs/dotnet-csharp/chat_permission_policies/). You can create a guest user session by using `setGuestUser` instead of `connectUser`.
...
> [!NOTE]
> The user object schema is the same as the one described in the [Initialization and Users](/chat/docs/dotnet-csharp/init_and_users/) portion of the docs.
