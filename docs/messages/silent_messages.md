...
> [!NOTE]
> Silent messages still trigger push notifications by default. Set `skip_push: true` to disable push notifications. See [Messages Overview](/chat/docs/dotnet-csharp/send_message/) for details.
