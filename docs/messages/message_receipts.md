...
For marking channels as read/unread and retrieving unread counts, see [Unread Counts](/chat/docs/dotnet-csharp/unread/).
...
For handling these events and updating unread counts, see [Unread Counts](/chat/docs/dotnet-csharp/unread/).
